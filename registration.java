...
public class registration {
	...
	public static void main(String[] args) throws Exception {
		...
		while(true) {
			try {
				...
				System.out.println("性别应输入数字, 请重新输入:");
				s = new Scanner(System.in);
				continue;
	 ...
	 * 输入年龄的方法
	 */
	public static int inputAge() throws AgeException, InputMismatchException{
		// 补充代码
		int age = 0;
		try {
			age = s.nextInt();
	 ...
	 * 选择性别的方法
	 */
	public static String setGender() throws GenderException, InputMismatchException {
